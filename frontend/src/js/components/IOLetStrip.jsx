...
function IOLetStrip(props)
{
    ...
    for (let i = 0; i < props.numIOLets; i++) {
        iolets.push(<IOLet handleRef={props.handleRef} updateShowInfo={props.updateShowInfo} key={props.id + ":" + {type} + "" + i} ioletIndex={i} parentId={props.id} connectionType={type}></IOLet>)
    }
